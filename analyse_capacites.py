...
par une vue d'ensemble, sur des demandes variées et jamais vues.
    ...
    python analyse_capacites.py checkpoints/carl_v13/best.pt            # Carl et l'aiguilleur
    python analyse_capacites.py checkpoints/carl_v13/best.pt --seul     # Carl seul
...
def main() -> None:
    ...
    chemin = next((a for a in sys.argv[1:] if not a.startswith("-")), "checkpoints/carl_v13/best.pt")
    device = get_device()
